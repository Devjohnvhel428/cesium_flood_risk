...
const HelpPage = ({ open, onClose }: DialogProps) => (
    <CalciteDialog open={open} modal scale="m" widthScale="m" closeDisabled outsideCloseDisabled id="confirm-dialog">
            ...
            <Paper elevation={3} sx={{ padding: 4, maxWidth: 800, margin: "0 auto" }}>
                ...
                <Grid container spacing={2}>
                        ...
                        <Accordion>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    ...
                                    detailed weather information for the selected city, including temperature, humidity,
                                    and wind speed.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                    ...
                    <Grid item xs={12}>
                        <Accordion>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    - Flood alerts are displayed on the map as circular regions. <br />- Click on a city
                                    with a flood alert to view more details about the alert. <br />- The radius of the
                                    alert is determined using data from the OpenStreetMap API.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                    </Grid>
                        ...
                        <Accordion>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    ...
                                    - Zoom in and out or pan across the map to explore different regions. <br />- The
                                    map is powered by CesiumJS for 3D geospatial visualization.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                    </Grid>
                    ...
                    <Grid item xs={12}>
                        <Accordion>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    The project uses mock data because the Weatherbit API requires a premium account for
                                    full access. However, the mock data closely simulates real-world weather information
                                    to provide an accurate user experience.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                    </Grid>
                ...
                <Box sx={{ marginTop: 4, textAlign: "center" }}>
                    <Typography variant="body2" color="textSecondary">
                        If you have further questions, feel free to contact the development team. Thank you for using
                        our project! This is the demo video of how you can use the project.
                        <br />
                        <iframe
                            title="demo video"
                            style={{ border: "none" }}
